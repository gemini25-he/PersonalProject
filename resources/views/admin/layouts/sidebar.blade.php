<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseBrands" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('brands.index') }}">Brands List</a>
                <a class="collapse-item" href="{{ route('brands.deleted') }}">Deleted Brands</a>
            </div>
        </div>
    </li>
    {{-- ---------- Brands --------------------- --}}
    ...
    <li class="nav-item">
        ...
        <div id="collapseColors" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('colors.index') }}">Colors List</a>
                <a class="collapse-item" href="{{ route('colors.deleted') }}">Deleted Colors</a>
            </div>
        </div>
    </li>
    {{-- ---------- Colors --------------------- --}}
